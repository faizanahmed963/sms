...
$sql_ins=mysqli_query($db,"INSERT INTO teacher_tbl VALUES( NULL,'$f_name','$l_name' ,'$gender','$dob','$addr','$degree','$salary' ,'$married','$phone','$mail')");
if($sql_ins==true) {
    $msg = ucfirst($f_name) ;
    echo "<div>"
...
if(isset($_POST['btn_upd'])){
	...
	$sql_update=mysqli_query($db,"UPDATE teacher_tbl SET
							f_name='$f_name' ,
							l_name='$l_name' ,
							gender='$gender' ,
							dob='$dob' ,
...
if($opr=="upd")
{
	$sql_upd=mysqli_query($db,"SELECT * FROM teacher_tbl WHERE teacher_id=$id");
