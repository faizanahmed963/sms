...
$sql_ins=mysqli_query($db,"INSERT INTO users_tbl 
						VALUES(
							NULL,
							'$username',
							'$pwd' ,
...
if(isset($_POST['btn_upd'])){
	...
	$sql_update=mysqli_query($db,"UPDATE users_tbl SET 
								username='$username' ,
								password='$pwd' , 
								type='$type'
							WHERE
...
if($opr=="upd")
{
	$sql_upd=mysqli_query($db,"SELECT * FROM users_tbl WHERE u_id=$id");
